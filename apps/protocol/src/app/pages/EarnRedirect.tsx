...
export const EarnRedirect: FC = () => {
  ...
  return (
    <Container>
      <PageHeader massetSwitcher title="Earn" subtitle="Ecosystem rewards with fStable" />
      <div>
        Visit the <ExternalLink href={`https://earn.metafury.app/#/${selectedMassetName}/earn`}>Earn App</ExternalLink> to access Earn.
      </div>
    </Container>
  )
}
