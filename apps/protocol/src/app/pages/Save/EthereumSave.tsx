...
export const EthereumSave: FC = () => {
  ...
  const handleGovernanceClick = (): void => {
    window.open('https://staking.metafury.app/', '_blank')
  }
          ...
          <Container>
            ...
            <Content>
              ...
              <Sidebar>
                ...
                />
                <InfoBox highlight subtitle="Using mFury Save">
                  <p>
                  ...
                  <p>
                    ...
                    <a href="https://docs.metafury.app/advanced/app-usage-terms-and-conditions">this page</a> to understand these risks more.
                  </p>
                </InfoBox>
              </Sidebar>
            </Content>
