    ...
    <Container>
      <div>
        <div>
          ...
          <h3>Powered by lending markets in DeFi and the mFury AMM.</h3>
        </div>
        <ButtonContainer>
          {!isSaveV1 && (
          ...
          <Button
            onClick={() => {
              window.open('https://docs.metafury.app/advanced/app-usage-terms-and-conditions')
            }}
          >
            Risks ↗
          </Button>
      ...
      <div>
        ...
        <APYText>
          ...
          <Tooltip tip="Learn about how this is calculated" hideIcon>
            <InfoLink>
              <a
                href="https://docs.metafury.app/using-mfury/mfury-app/save#understanding-save"
                target="_blank"
