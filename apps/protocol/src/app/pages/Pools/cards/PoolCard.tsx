      ...
      {!deprecated && (
        <StatsContainer>
          {!!feederPool?.vault && !!(feederPoolApy.value?.rewards.base || feederPoolApy.value?.rewards.maxBoost) && (
            <RewardsAPY>
              <p>
                <Tooltip tip="33% of earned FURY rewards are claimable immediately. The remaining rewards are streamed linearly after 26 weeks">
                  Rewards APY
                </Tooltip>
              </p>
              <div>
                <div>
                  ...
                  <div>
                    &nbsp;→&nbsp;
                    <UnderlinedTip tip="Max boost can be achieved by staking FURY" hideIcon>
