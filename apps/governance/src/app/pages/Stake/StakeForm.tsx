  ...
  return (
    <Container className={className}>
      ...
      <Warnings>
        ...
        <Warning>
          In the event that the mFury protocol requires recollateralisation, you risk getting diluted{' '}
          <a href="https://docs.metafury.app/using-mfury/fury-staking/staking-v2" target="_blank" rel="noopener noreferrer">
            Learn More
          </a>
        </Warning>
      </Warnings>
