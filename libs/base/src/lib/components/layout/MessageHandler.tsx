  ...
  olympus: {
    ...
    content: (
      <p>
        ...
        <a
          href="https://pro.olympusdao.finance/?utm_source=mFury&utm_medium=affiliate&utm_campaign=op-affiliate"
          target="_blank"
  ...
  shutdown: {
    ...
    content: (
      <Container>
        {/* <Modal>
          <WarningIcon />
          <p>mFury has been aquired by dHedge. Following the outlined aquisition update, certain mFury products will be sunset.</p>
          <p>
