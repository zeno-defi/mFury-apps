...
const socialIcons = [
  { title: 'Github', icon: Github, href: 'https://github.com/metafury-app' },
  ...
  // { title: 'Email', icon: Email, href: 'mailto:info@metafury.app' },
]
...
export const Footer: FC = () => {
  ...
  const href = appName === APP_NAME.GOVERNANCE ? 'https://metafury.app/#/' : 'https://staking.metafury.app/'
      ...
      <Inner>
        <div>
          <div>
            <div>
              <b>mFury</b>&nbsp;|&nbsp;
              <Link href="https://yield.metafury.app/" target="_blank" rel="noreferrer">
                Yield app&nbsp;<span>↗</span>
              </Link>
              &nbsp;|&nbsp;
        ...
        <RiskLink href="https://docs.metafury.app/advanced/app-usage-terms-and-conditions" target="_blank" rel="noopener noreferrer">
